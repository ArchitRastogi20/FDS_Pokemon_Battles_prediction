...
try:
    if os.path.exists('submission_2/model_config_and_feature_selection/feature_flags.json'):
        with open('submission_2/model_config_and_feature_selection/feature_flags.json', 'r') as f:
            loaded = json.load(f)
...
def main():
    ...
    aligned = False
    try:
        with open('submission_2/model_config_and_feature_selection/feature_names.json', 'r') as f:
    ...
    # Save to CSV
    output_file = 'submission_2/model_config_and_feature_selection/test_features.csv'
