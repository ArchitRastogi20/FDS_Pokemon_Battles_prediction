...
try:
    ...
    print(f"  Data quality: Nulls={null_count} {'✓' if null_count==0 else '✗'} | Infs={inf_count} {'✓' if inf_count==0 else '✗'}")
...
proba_file = 'test_probabilities.csv'
...
print(f"  3. Check leaderboard score!")
print(f"{'='*80}\n")
